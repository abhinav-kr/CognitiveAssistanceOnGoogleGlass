...
public class VideoStreamingThread extends Thread {
	...
	private static final String LOG_TAG_IV = "iv";
	...
	private String detectionAlgorithm = "esvm";
	private String objectToDetect = "cup";
...
//					Log.d(LOG_TAG, "waiting");
				...
				Log.d(LOG_TAG_IV, "Frame " + sendingFrameID + " sent time : " + System.currentTimeMillis());
	...
	public void setObjectToDetect(String objectToDetect) {
